                ...
                <!-- Product Listing Container -->
                    <div class="flex-1">
                        ...
                        <div v-else>
                            ...
                            <template v-if="isLoading">
                                <div
                                    class="mt-8 grid grid-cols-3 gap-8 max-1060:grid-cols-2 max-md:gap-x-4 max-sm:mt-5 max-sm:justify-items-center max-sm:gap-y-5">
        ...
        <script type="module">
            app.component('v-search', {
                ...
                methods: {
                    ...
                    ///////////////////////////////////////////////////////////////////////////
                    async fetchProducts() {
                        // Reset states and validate the input
                        this.error = "";
                        this.loading = true;

                        try {

                            const response = await axios.get(`https://fakestoreapi.com/products/${this.queryParams.query}`);


                            if (response.data) {
                                const result = await axios.post('http://localhost/bagisto/public/admin/catalog/products/create', {

                                    attribute_family_id: "1",
                                    sku: "productid" + this.queryParams.query,
                                    type: "simple",
                                })
                        ...
                        alert("le produit a été créé avec succès")
                            ...
                            this.error = "Failed to load the product. Please check the ID.";
                            console.error(err);
                        } finally {
                            this.loading = false;
                        }
